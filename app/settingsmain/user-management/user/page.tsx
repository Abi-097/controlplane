"use client";
import { columns } from "@/app/components/Settings/UserManagment/User/UsermanagementUserColumn";
import { UserManagementUserTable } from "@/app/components/Settings/UserManagment/User/UsermanagementUserTable";
  ...
  return (
    <div className="overflow-auto w-full h-full">
      ...
      <div className="overflow-x-auto">
        <UserManagementUserTable columns={columns} data={data} />
      </div>
    </div>
  );
};
