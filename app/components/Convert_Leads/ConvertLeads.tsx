...
const ConvertLeads: React.FC<ConvertContactProps> = ({ trigger }) => {
  ...
  return (
    <>
      ...
      <Dialog>
        ...
        <DialogContent className="fixed bg-white py-2 px-4 rounded-md shadow-lg top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[650px] z-[999]">
