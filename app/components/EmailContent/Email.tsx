...
const EmailDialog = ({ onClose }: { onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#CCCCCC] bg-opacity-5 flex items-center justify-center z-[999]">
      <form onSubmit={handleSubmit}>
        <div
          className={`fixed bottom-0 right-9 shadow-md bg-white rounded-md  ${
            isExpanded
              ? "h-auto w-[70%]"
        ...
        >
          ...
          <div className="flex justify-between items-center pb-2 px-2 bg-[#f7f7f7] border-t border-gray-300">
            ...
            <div>
              <FillButton
                //   type="submit"
                className="text-white rounded-md text-sm py-1 px-2 bg-saveButton"
              >
