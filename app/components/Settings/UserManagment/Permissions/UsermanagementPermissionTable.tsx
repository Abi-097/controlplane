...
interface UserManagementPermissionTableTableProps<TData, TValue> {
...
export function UserManagementPermissionTable<TData, TValue>({
  columns,
  data,
}: //   heading,
//   isExpanded,
UserManagementPermissionTableTableProps<TData, TValue>) {
    ...
    <>
      ...
      <div className="flex justify-between items-center px-4 py-2">
        <div className="flex items-center gap-2">
          ...
          <p className="font-semibold">User Management - Permission</p>
        </div>
