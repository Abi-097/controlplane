...
export const columns: ColumnDef<APIColumnProps>[] = [
  {
    accessorKey: "name",
    header: ({ column }) => {
      return (
        <div
          className="flex items-center gap-2 cursor-pointer select-none text-[13px] text-white font-semibold"
  ...
  },
  {
    ...
    header: () => {
      return (
        <div className="flex items-center gap-2 cursor-pointer select-none text-[13px] text-white font-semibold">
          Action
        </div>
      );
    },
