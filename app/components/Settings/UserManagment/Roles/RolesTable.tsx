...
import AddPolicyGroupDialog from "./AddRolesDialog";
import History from "@/app/components/History/History";
import { LockKeyhole } from "lucide-react";

interface RolesTableProps<TData, TValue> {
    ...
    <>
      ...
      <div className="flex justify-between items-center px-4 py-2">
        <div className="flex items-center gap-2">
          <LockKeyhole size={24} />
          <p className="font-semibold">User Management - Role</p>
        </div>
            ...
            <AddPolicyGroupDialog
              trigger={
                <FillButton className="px-3 py-1 bg-saveButton">
                  <p className="text-sm">Add Role</p>
                </FillButton>
              }
            />
          </div>
