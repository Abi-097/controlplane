...
interface UserManagementUserTableProps<TData, TValue> {
...
export function UserManagementUserTable<TData, TValue>({
  columns,
  data,
}: //   heading,
//   isExpanded,
UserManagementUserTableProps<TData, TValue>) {
    ...
    <>
      ...
      <div className="flex justify-between items-center px-4 py-2">
        <div className="flex items-center gap-2">
          <UserRound size={24} />
          <p className="font-semibold">User Management - User</p>
        </div>
