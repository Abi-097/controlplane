...
interface PolicyGroupTableProps<TData, TValue> {
...
export function PolicyGroupTable<TData, TValue>({
  columns,
  data,
}: //   heading,
//   isExpanded,
PolicyGroupTableProps<TData, TValue>) {
    ...
    <>
      ...
      <div className="flex justify-between items-center px-4 py-2">
        <div className="flex items-center gap-2">
          <CgProfile size={24} />
          <p className="font-semibold">Policy Group</p>
        </div>
        <div className="flex items-center justify-center gap-3">
          ...
          <div>
            <AddPolicyGroupDialog
              mode="addPolicyGroup"
              trigger={
                <FillButton className="px-3 py-1 bg-saveButton">
                  <p className="text-sm">Add Policy Group</p>
                </FillButton>
              }
            />
          </div>
      ...
      {/* <div className="flex-1 max-h-[650px] w-full px-1 overflow-auto"> */}
      <div
        ref={tableRef}
