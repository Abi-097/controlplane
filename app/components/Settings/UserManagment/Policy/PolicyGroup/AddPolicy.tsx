...
interface AddPolicyGroupDialogProps {
  trigger: React.ReactNode;
  mode: "addPolicyGroup" | "editPolicyGroup";
...
const AddPolicyGroupDialog: React.FC<AddPolicyGroupDialogProps> = ({
  trigger,
  mode,
  contactData,
}) => {
    ...
    <div>
      <Dialog>
        ...
        <DialogContent className="fixed bg-white p-4 rounded-md shadow-lg top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[600px] max-h-[80%] overflow-x-auto">
          ...
          xl:w-[55%]"
                >
                  <Label className="text-md mb-1 ">Policy Group name</Label>
                  <Input
                    className="bg-[#f9fafb]"
                    type="text"
                    id="name"
...
export default AddPolicyGroupDialog;
