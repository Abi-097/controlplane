...
// import AddPolicyGroupDialog from "./AddPolicy";
import { PiPlugs } from "react-icons/pi";
import AddPolicyActionDialog from "./AddPolicyAction";
import History from "@/app/components/History/History";

interface PolicyActionTableProps<TData, TValue> {
...
export function PolicyActionTable<TData, TValue>({
  columns,
  data,
}: //   heading,
//   isExpanded,
PolicyActionTableProps<TData, TValue>) {
    ...
    <>
      ...
      <div className="flex justify-between items-center px-4 py-2">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <div>
            <AddPolicyActionDialog
              trigger={
                <FillButton className="px-3 py-1 bg-saveButton hover:hover:bg-hoverSaveButton">
                  <p className="text-sm">Add Policy Action</p>
                </FillButton>
              }
            />
          </div>
