...
import AddPolicyAuthTypeDialog from "./AddPolicyPolicyDialog";
import AddPolicyPolicyDialog from "./AddPolicyPolicyDialog";
import History from "@/app/components/History/History";
import { LockKeyhole } from "lucide-react";

interface PolicyPolicyTableProps<TData, TValue> {
...
export function PolicyPolicyTable<TData, TValue>({
  columns,
  data,
}: //   heading,
//   isExpanded,
PolicyPolicyTableProps<TData, TValue>) {
    ...
    <>
      ...
      <div className="flex justify-between items-center px-4 py-2">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <div>
            <AddPolicyPolicyDialog
              trigger={
                <FillButton className="px-3 py-1 bg-saveButton">
                  <p className="text-sm">Add Policy</p>
                </FillButton>
              }
            />
          </div>
