...
interface AddPolicyAuthTypeDialogProps {
...
const AddPolicyAuthTypeDialog: React.FC<AddPolicyAuthTypeDialogProps> = ({
  trigger,
  //   mode,
  contactData,
}) => {
...
export default AddPolicyAuthTypeDialog;
