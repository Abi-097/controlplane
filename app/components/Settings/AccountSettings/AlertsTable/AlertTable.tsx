...
interface AlertTableProps<TData, TValue> {
...
export function AlertTable<TData, TValue>({
  columns,
  data,
}: AlertTableProps<TData, TValue>) {
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center pb-2 pr-7 pl-2 ">
        <div className="flex items-center gap-3">
          ...
          <Image
            ...
            height={20}
          />
          <p className="text-sm">Organizational Announcement</p>
        </div>
