      ...
      <div className="flex justify-between items-center pb-2 px-7">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="relative max-w-sm mt-1">
            ...
            <Input
              placeholder="Search Budgets & Alerts"
              value={
          ...
          <div>
            <FillButton
              className="px-2 py-1 bg-saveButton hover:hoverSaveButton"
              onClick={onAddBudgetClick}
            >
              <p className="text-sm">Add Budget</p>
            </FillButton>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between gap-3  my-4 ">
          ...
          <div className="w-full ">
            <Select>
              ...
              <SelectContent>
                <SelectGroup>
                  <SelectItem value="apple">All Period</SelectItem>
