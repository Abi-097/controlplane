...
interface BillingSoldContactDialogProps {
  trigger: React.ReactNode;
  isSoldToContact: boolean;
}

const BillingSoldContactDialog: React.FC<BillingSoldContactDialogProps> = ({
  trigger,
  isSoldToContact,
}) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="fixed bg-white p-4 rounded-md shadow-lg top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[1000px] max-h-auto overflow-x-auto">
        <DialogHeader>
          <DialogTitle>Sold to Contact</DialogTitle>
          <hr className="my-2" />
        </DialogHeader>
        {/* <BillingContactMain isSoldToContact={true} /> */}
...
export default BillingSoldContactDialog;
