...
interface BackupPaymentMethodDialogProps {
  trigger: React.ReactNode;
}

const BackupPaymentMethodDialog: React.FC<BackupPaymentMethodDialogProps> = ({
  trigger,
}) => {
  return (
    <Dialog>
...
export default BackupPaymentMethodDialog;
