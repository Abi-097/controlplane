...
import TaskEngagementDialoge from "./TasksEngagementDialogebox";


interface TaskEngagementTableProps<TData, TValue> {
...
export function TaskEngagementTable<TData, TValue>({
  columns,
  data,
}: //   heading,
//   isExpanded,
TaskEngagementTableProps<TData, TValue>) {
  ...
  return (
    <>
      ...
      <div className="flex-1 max-h-[650px] w-full overflow-auto bg-white">
