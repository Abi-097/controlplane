...
const QuotesHistoryGride: React.FC<GridCardProps> = ({ products }) => {
                ...
                <div className="flex items-start gap-7 w-full">
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <div className="flex flex-row items-left pt-1 text-gray-500 text-sm">
                      <div className=" text-gray-800 w-[200px] "> Cost: ${product.amount} USD</div>
...
export default QuotesHistoryGride;
