...
import QuotesHistoryGride from "./QuotesHistoryGride";
import { QuotesHistoryTable } from "./QuotesHistoryTable";
import { QuotesHistoryTablecolumns } from "./QuotesHistoryTableColumns";
...
const History_quotes = () => {
  ...
  return (
    <div className="bg-white p-2 h-full ">
      ...
      {isSearchActive ? (
        <QuotesHistoryTable
          columns={QuotesHistoryTablecolumns}
          data={productData}
        />
      ) : (
        <QuotesHistoryGride products={productData} />
      )}
    </div>
  );
};

export default History_quotes;
