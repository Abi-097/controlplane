...
const OpportunityContacts: React.FC<GridCardProps> = ({ users }) => {
  ...
  return (
    <>
      <div className="flex flex-row text-sm justify-between items-center pb-0 w-full rounded-sm no-scrollbar"></div>

      <div className="grid gap-2 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 justify-start no-scrollbar">
        {users.map((user) => (
