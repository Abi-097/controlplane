...
import StageHistoryGride from "./StageHistoryGride";
...
const History_stageHistory = () => {
  ...
  return (
    <div className="bg-white p-2">
      ...
      {isSearchActive ? (
        <StageHistoryTable columns={columns} data={data} />
      ) : (
        <StageHistoryGride users={users} />
      )}
    </div>
  );
};

export default History_stageHistory;
