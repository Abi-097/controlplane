...
import { columns } from "@/app/components/HistoryTable/HistoryColumnTable"; // Assuming columns are the same for both tables
import { TbLayoutGrid, TbLayoutList } from "react-icons/tb";
import { Button } from "@/components/ui/button";
import PartnerHistoryGride from "./PartnerHistoryGride";
...
const users = [
  {
    ...
    desHead:"Hello Hello",
    desBody:"loram expodam in to the emergency contacts. this is the mock data",
  },
  {
    id: 2,
    name: "Jane Smith",
  ...
  return (
    <div className="bg-white p-2">
      <div className="flex justify-between items-center pb-2">
        <div className="flex items-center gap-3 pl-2 text-sm font-semibold">Partner History</div>
      ...
      {isSearchActive ? (
        <PartnerHistoryGride users={users} />
      ) : (
        <PartnerHistoryTable columns={columns} data={data} />
      )}
    </div>
  );
};

export default History_partner;
